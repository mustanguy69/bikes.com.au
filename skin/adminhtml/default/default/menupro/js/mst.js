		...
		*/
		...
		groupPreview : function() {
			var groupId = $("#group_id").val(),
				url = $("#baseurl").val() + "menupro/index/groupPreview?group_id=" + groupId + "&";
			$(window.document).on("click", ".btn-group-preview", function() {
