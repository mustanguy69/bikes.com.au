jQuery(document).ready(function(){
    ...
    var content = '<div class="col-sm-9">\n' +
        ...
        '<div class="col-sm-12" style="margin:0;background-color: rgba(249, 246, 9,0.5);padding-top: 15px;padding-bottom: 8px">\n' +
        '<div class="maps"><span style="font-size: 25px;color: black;">MASSIVE SAVINGS ON ALL SCOTT & FOCUS BIKES .</span></div>'+
        '</div>';
