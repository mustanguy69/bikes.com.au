...
AmAjax.prototype =
{
    ...
    sendAjax : function(idProduct, param, oldEvent, element) {
        if (idProduct) {
            ...
            setTimeout(removeCartInSidebar, 3000);
        }
    },
    ...
    createMinicart: function() {
        ...
        if (nmCart) {
            ...
            if (nmCart.parentNode) {
                ...
                var minicartContainer = $$('.topcart-mini-container')[0];
                if(typeof minicartContainer != 'undefined') {
                    Event.observe(minicartContainer, 'click',function() {
                        //jQuery(".topcart-mini-container").toggleClass( "highlight" );
                        minicartContainer.toggleClassName( "highlight" );
                    });
                }
    ...
    updateMinicart: function() {
        ...
        var element = $$('.topcart-mini-container')[0];
        if (!element) return;
