    ...
    try {
        jQuery.ajax({            url: url,
			...
			complete: function(){
                ...
                jQuery(minicartContainer).on('click',function(){
                    minicartContainer.toggleClass( "highlight" );
                });
            ...
            success: function(data){
                ...
                removeCartInSidebar();  // jQuery(".header-cart-mini .cart-mini-title").click(function(){ jQuery(".header-cart-mini .top-cart-content").toggle(); });
            return false;
            }
        });
    } catch (e) {
