...
class Fooman_Connect_Block_Adminhtml_Invoice_Grid extends Fooman_Connect_Block_Adminhtml_Common_Grid
{

    protected function _prepareCollection()
    {
        $collection         = Mage::getModel('foomanconnect/invoice')->getCollection();
        ...
        $collection->getSelect()->joinLeft(
            ...
            "`order_address`.`parent_id` = `_invoice_table`.`order_id` AND `order_address`.`address_type`='billing'",
    ...
    protected function _prepareColumns()
    {
        ...
        $this->_addActionColumn('adminhtml/sales_invoice/view', 'invoice_id');
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            'export_selected', array(
                ...
                'url'   => $this->getUrl('*/*/exportSelectedInvoices'),
            )
        );
        ...
        $this->getMassactionBlock()->addItem(
            'set_as_exported_selected', array(
                ...
                'url'   => $this->getUrl('*/*/neverExportSelectedInvoices'),
            )
        );
        ...
        $this->getMassactionBlock()->addItem(
            'set_as_exported_selected', array(
                ...
                'url'   => $this->getUrl('*/*/voidSelectedInvoices'),
            )
        );
    }
