...
class Fooman_Connect_Block_Adminhtml_Invoice extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('foomanconnect')->__('Fooman Connect: Xero - Invoices');
