...
class Fooman_Connect_Model_System_TaxExpenseZeroOptions extends Fooman_Connect_Model_System_Abstract
{
    ...
    public function toOptionArray()
    {
        ...
        if ($this->isConfigured() && Mage::getStoreConfig('foomanconnect/settings/xeroenabled')) {
            ...
            foreach ($result as $taxRate) {
                if ($taxRate['EffectiveRate'] == 0 && $taxRate['Status'] == 'ACTIVE' && $taxRate['CanApplyToExpenses']) {
                    $returnArray[] = array(
