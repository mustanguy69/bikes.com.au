...
class Magmodules_Googleshopping_Model_Adminhtml_System_Config_Source_Productid
{
    ...
    {
        $options = array();
        $options[] = array('value' => 'entity_id', 'label' => Mage::helper('googleshopping')->__('Product ID'));
