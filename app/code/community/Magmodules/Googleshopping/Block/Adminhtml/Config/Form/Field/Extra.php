    ...
    extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    public function __construct()
    {
        ...
        $rendererAttribute = $layout->createBlock('googleshopping/adminhtml_config_form_renderer_select', '', array('is_render_to_js_template' => true));
        $rendererAttribute->setOptions(Mage::getModel('googleshopping/adminhtml_system_config_source_attribute')->toOptionArray());

        $rendererAction = $layout->createBlock('googleshopping/adminhtml_config_form_renderer_select', '', array('is_render_to_js_template' => true));
        $rendererAction->setOptions(Mage::getModel('googleshopping/adminhtml_system_config_source_action')->toOptionArray());
