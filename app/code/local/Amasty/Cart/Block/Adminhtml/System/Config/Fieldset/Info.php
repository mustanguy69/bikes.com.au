...
class Amasty_Cart_Block_Adminhtml_System_Config_Fieldset_Info
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    protected $_contentHtml = '';
    protected $_moduleCode = 'Amasty_Cart';
    protected $_userGuideLink = 'https://amasty.com/media/user_guides/ajax_shopping_cart_user_guide.pdf';
