<?php
class Themevast_Mostviewed_Block_Mostviewed extends Mage_Catalog_Block_Product_Abstract
{
	...
	{
		if(!$this->_config) $this->_config = Mage::getStoreConfig('mostviewed/general'); 
	}
