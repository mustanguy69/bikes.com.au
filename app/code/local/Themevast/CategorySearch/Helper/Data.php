<?php
class Themevast_CategorySearch_Helper_Data extends Mage_Core_Helper_Abstract
{
    const XML_PATH_SHOW_SUBCATEGORIES                = 'categorysearch/settings/show_subcategories';
    const XML_PATH_SUBCATEGORIES_LEVEL                = 'categorysearch/settings/subcategories_level';
    const XML_PATH_INDENTATION_TEXT                  = 'categorysearch/settings/indentation_text';
    const XML_PATH_SELECT_CATEGORY_ON_CATEGORY_PAGES = 'categorysearch/settings/select_category_on_category_pages';
