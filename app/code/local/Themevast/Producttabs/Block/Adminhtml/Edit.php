<?php
class Themevast_Producttabs_Block_Adminhtml_Edit extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    private function _appendHtml() {
		...
		<div id="logo_wrapp"><a href="' . $this->homeUrl . '" target="_blank">Plazathemes</a></div>
		';
        return $html;
    }
