...
abstract class Mage_Sales_Model_Order_Pdf_Abstract extends Varien_Object
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $paymentInfo = Mage::helper('payment')->getInfoBlock($order->getPayment())
            ->setIsSecureMode(false) /* was "true" to hide payment details */
            ->toPdf();
        /* $paymentInfo = htmlspecialchars_decode($paymentInfo, ENT_QUOTES); */ /* enable this line to hide payment details */
        ...
        if (!$order->getIsVirtual()) {
            ...
            $shippingAddress = $this->_formatAddress($order->getShippingAddress()->format('pdf').'|'.Mage::helper('sales')->__('E: ').$order->getCustomerEmail());
     ...
     */
    protected function _setFontRegular($object, $size = 14)
    {
     ...
     * @return Zend_Pdf_Resource_Font
     */
    protected function _setFontBold($object, $size = 14)
    {
     ...
     * @return Zend_Pdf_Resource_Font
     */
    protected function _setFontItalic($object, $size = 14)
    {
