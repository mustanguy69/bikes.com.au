...
class MagicScrollModuleCoreClass
{
    ...
    public function getHeadersTemplate($jsPath = '', $cssPath = null, $linkModuleCss = true)
    {
        ...
        $headers = array();
        // add module version
        $headers[] = '<!-- Magic Zoom Plus Magento module version v4.15.7 [v1.6.71:v5.2.5] -->';
        $headers[] = '<script type="text/javascript">window["mgctlbx$Pltm"] = "Magento";</script>';
        // add tool style link
        $headers[] = '<link type="text/css" href="'.$cssPath.'/magicscroll.css?v=1" rel="stylesheet" media="screen" />';
        if ($linkModuleCss) {
