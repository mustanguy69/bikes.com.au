...
<script type="text/javascript">
    ...
    var fieldsets = getElementsByClass("magiczoomplus-fieldset");
    var header = null;
    var buttons = null;
    ...
    initOptionsValidation("magiczoomplus[desktop][product][template]", "magiczoomplus[desktop][product][magicscroll]");
