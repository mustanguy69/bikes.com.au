...
class MagicToolbox_MagicZoomPlus_Model_Mysql4_Settings_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    protected function _afterLoad()
    {
        ...
        foreach ($this->_items as $item) {
            ...
            //if ($package == 'all') {
            //    $item->setData('package_theme', 'Edit Magic Zoom Plus&#8482; default settings');
            //} else {
