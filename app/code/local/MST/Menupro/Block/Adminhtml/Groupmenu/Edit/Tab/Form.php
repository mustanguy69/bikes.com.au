...
class MST_Menupro_Block_Adminhtml_Groupmenu_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('animation', 'select', array(
        		...
        		'required' => true,
        		'values' => $animations,
				'after_element_html' => '<a id="animation" style="cursor: pointer; text-decoration: none;" class="btn-group-preview">'. Mage::helper('menupro')->__('Screenshot') . '</a>',
        ));
        $fieldset->addField('position', 'select', array(
        		...
        		'required' => true,
        		'values' => $positions,
				'after_element_html' => '<a id="position" style="cursor: pointer; text-decoration: none;" class="btn-group-preview">'. Mage::helper('menupro')->__('Screenshot') . '</a>',
        ));
        $fieldset->addField('responsive', 'select', array(
        		...
        		'required' => true,
        		'values' => $responsives,
				'after_element_html' => '<a id="responsive" style="cursor: pointer; text-decoration: none;" class="btn-group-preview">'. Mage::helper('menupro')->__('Screenshot') . '</a>',
        ));
