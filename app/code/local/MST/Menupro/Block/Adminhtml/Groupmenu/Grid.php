	...
	protected function _prepareColumns() {
		...
		$this->addColumn ( 'responsive', array (
				...
				'options' => array (
						...
						'mcp-push-cover' => 'Responsive multi-level push covering', 
						'mcp-push-overlap' => 'Responsive multi-level push overlapping',
						'mcp-multilevel-style-1' => 'Responsive multi-level style 1',
						'mcp-multilevel-style-2' => 'Responsive multi-level style 2',
						'mcp-multilevel-style-3' => 'Responsive multi-level style 3',
						'mcp-multilevel-style-4' => 'Responsive multi-level style 4',
						'mcp-multilevel-style-5' => 'Responsive multi-level style 5',
