...
class MST_Menupro_Model_Groupmenu extends Mage_Core_Model_Abstract {
	...
	public function getResponsives() {
		return array (
				...
				array (
						'value' => 'mcp-push-cover',
						'label' => 'Responsive multi-level push covering'
				),
				array (
						'value' => 'mcp-push-overlap',
						'label' => 'Responsive multi-level push overlapping'
				),
				array (
						'value' => 'mcp-multilevel-style-1',
						'label' => 'Responsive multi-level style 1'
				),
				array (
						'value' => 'mcp-multilevel-style-2',
						'label' => 'Responsive multi-level style 2'
				),
				array (
						'value' => 'mcp-multilevel-style-3',
						'label' => 'Responsive multi-level style 3'
				),
				array (
						'value' => 'mcp-multilevel-style-4',
						'label' => 'Responsive multi-level style 4'
				),
				array (
						'value' => 'mcp-multilevel-style-5',
						'label' => 'Responsive multi-level style 5'
				),
				array (
						'value' => 'disable',
	...
	public function getMobileResponsiveStyles () {
		return array(
			'mcp-push-cover',
			'mcp-push-overlap',
			'mcp-multilevel-style-1',
			'mcp-multilevel-style-2',
			'mcp-multilevel-style-3',
			'mcp-multilevel-style-4',
			'mcp-multilevel-style-5',
		);
	}
