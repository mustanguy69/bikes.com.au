...
class Megantic_Assigncategory_Block_Adminhtml_Assigncategory_Edit_Tab_CategoriesRemove extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
       parent::__construct();
       $this->setTemplate('assigncategory/category/categories_remove.phtml');
    }
    ...
    {
        return $this->getUrl('*/*/categoriesremoveJson', array('_current' => true));
    }
