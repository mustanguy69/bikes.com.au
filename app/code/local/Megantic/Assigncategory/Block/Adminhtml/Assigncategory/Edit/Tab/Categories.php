...
class Megantic_Assigncategory_Block_Adminhtml_Assigncategory_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('assigncategory/category/categories.phtml');
    }
