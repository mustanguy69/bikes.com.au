...
class Megantic_Assigncategory_Helper_Category extends Mage_Core_Helper_Abstract
{
    ...
    public function getOptionsForFilter()
    {
        ...
        $parentId       = $storeId > 0 ? Mage::helper('assigncategory')->getStore()->getRootCategoryId() : Mage_Catalog_Model_Category::TREE_ROOT_ID;
